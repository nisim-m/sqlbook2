/*
  ...
  ・sqlcmd.exeの表示結果を見やすくするため文字長を(255)から調整
  ・CREATE TABLE時、ON DELETE RESTRICT の代わりに ON DELETE NO ACTIONを使用
*/
...
CREATE TABLE students (
    ...
    student_yomi VARCHAR(40) NOT NULL,
...
CREATE TABLE exams ( 
    ...
    subject VARCHAR(30) NOT NULL CHECK (subject='国語'
    ...
    FOREIGN KEY (student_id) REFERENCES students (student_id)
        ON DELETE NO ACTION /* RESTRICT */ ON UPDATE CASCADE
);
...
bungu_name VARCHAR(30) NOT NULL,
