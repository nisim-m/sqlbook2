...
CREATE TABLE students (
  ...
  student_name VARCHAR(30) NOT NULL CHECK(student_name LIKE '%_ _%'),
  student_yomi VARCHAR(40) NOT NULL CHECK(student_yomi LIKE '%_ _%'),
...
FOREIGN KEY (student_id) REFERENCES students (student_id) ON DELETE NO ACTION /* RESTRICT */ ON UPDATE CASCADE);
